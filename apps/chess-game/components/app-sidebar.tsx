...
import { Crown, Gamepad2, Puzzle, GraduationCap, Eye, Newspaper, Users, Home, Trophy, Settings, HelpCircle, Info, Award } from "lucide-react"
          ...
          <div className="p-4 border-b border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sm text-sidebar-foreground truncate">Misafir</p>
