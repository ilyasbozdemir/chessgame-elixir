...
export const NewGamePanel = () => {
  return (
    <div className="space-y-3 md:space-y-4">
          ...
          {gameModes.map((mode) => (
            ...
            >
              ...
              <div className="flex-1 text-left">
                <div className="font-medium text-sm md:text-base">{mode.name}</div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base md:text-lg">Diğer Seçenekler</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2 md:space-y-3">
          <Button variant="outline" className="w-full justify-start gap-2 text-sm md:text-base h-auto py-2 md:py-3">
          ...
          <Button variant="default" className="w-full justify-start gap-2 text-sm md:text-base h-auto py-2 md:py-3">
            <Trophy className="w-4 h-4" />
            Turnuvalar
          </Button>
        </CardContent>
